        ...
        <div className="card m-4" style={{align:"center",backgroundColor:"#f8f7fb",borderRadius:"5px"}}>
           ...
           />
            ...
            <div className="card-body col-12" style={{padding:"3rem"}}>
                ...
                <p class="hizmetyazi">
                Titanyum Beauty Saloon olarak Lazer Epilasyon, G5 Masajı, Kavitasyon, Kirpik Lfiting, kaş Laminasyonu, PRP, Botoks, Hacamat, Medikal ve Hydrafacial Cilt Bakımı hizmetlerimiz mevcuttur. Kampanaylarımız ve detaylar için sosyal medya hesaplarımızı takipte kalın.
